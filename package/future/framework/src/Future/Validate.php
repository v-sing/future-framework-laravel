...
class Validate
{
    ...
    protected static $typeMsg = [
        ...
        'alphaDash'   => 'Validate alphaDash',
        'activeUrl'   => 'Validate activeUrl',
        'chs'         => 'Validate chs',
        'chsAlpha'    => 'Validate chsAlpha',
        'chsAlphaNum' => 'Validate chsAlphaNum',
        'chsDash'     => 'Validate chsDash',
        'url'         => 'Validate url',
        'ip'          => 'Validate ip',
        'dateFormat'  => 'Validate dateFormat',
        'in'          => 'Validate in',
        'notIn'       => 'Validate notIn',
        'between'     => 'Validate between',
        'notBetween'  => 'Validate notBetween',
        'length'      => 'Validate length',
        'max'         => 'Validate max',
        'min'         => 'Validate min',
        'after'       => 'Validate after',
        'before'      => 'Validate before',
        'afterWith'   => 'Validate afterWith',
        'beforeWith'  => 'Validate beforeWith',
        'expire'      => 'Validate expire',
        'allowIp'     => 'Validate allowIp',
        'denyIp'      => 'Validate denyIp',
        'confirm'     => 'Validate denyIp',
        'different'   => 'Validate different',
        'egt'         => 'Validate egt',
        'gt'          => 'Validate gt',
        'elt'         => 'Validate elt',
        'lt'          => 'Validate lt',
        ...
        'fileSize'    => 'Validate fileSize',
        'fileExt'     => 'Validate fileExt',
        'fileMime'    => 'Validate fileMime',
